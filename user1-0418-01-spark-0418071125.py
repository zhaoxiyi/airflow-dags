...
args = {
    "project_id": "user1-0418-01-spark-0418071125",
}

dag = DAG(
    "user1-0418-01-spark-0418071125",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user1-0418-01-spark.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="user1-0418-01-spark-0418071125",
